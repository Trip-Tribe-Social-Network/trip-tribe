...
class FriendshipTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(name='user1', password='password', email='user1@example.com')
        self.user2 = User.objects.create_user(name='user2', password='password', email='user2@example.com')
    ...
    def test_get_friends(self):
        ...
        self.assertEqual(response.json()['user']['name'], self.user1.name)
