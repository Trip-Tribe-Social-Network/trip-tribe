    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_notification', models.CharField(choices=[('newfriendrequest', 'New Friend Request'), ('acceptedfriendrequest', 'Accepted Friend Request'), ('rejectedfriendrequest', 'Rejected Friend Request'), ('postlike', 'Post Liked'), ('postcomment', 'Post Comment')], max_length=50)),
